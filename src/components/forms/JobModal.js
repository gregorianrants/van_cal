...
export default function JobModal({displayEvent,close,updateEvent}){
    ...
    /*const {start,end,customer,charges,operatives,items,addresses} = displayEvent*/
                                          ...
                                          <CardContent>
                                              <List className={classes.list}>
                                                  <ListItem>
                                                      ...
                                                      <ListItemText primary='Gregor Murray' secondary='name'/>
                                                  </ListItem>
                                                  <ListItem>
                                                      <ListItemIcon>
                                                          <PhoneIcon/>
                                                      </ListItemIcon>
                                                      <ListItemText primary='07930103787' secondary='mobile'/>
                                                  </ListItem>
                                                  <ListItem>
                                                      <ListItemIcon>
                                                          <EmailIcon/>
                                                      </ListItemIcon>
                                                      <ListItemText primary='gregorian_rants@hotmail.com' secondary='mobile'/>
                                                  </ListItem>
                                              </List>
                                          </CardContent>
                                      </Card>
                                          ...
                                          <CardContent>
                                              <List className={classes.list}>
                                                  <ListItem>
                                                      ...
                                                      <ListItemText primary='Fenwick Lawson' secondary='first man'/>
                                                  </ListItem>
                                                  <ListItem>
                                                      <ListItemIcon>
                                                          <AccessibilityNewIcon/>
                                                      </ListItemIcon>
                                                      <ListItemText primary='Brian Fireman' secondary='second man'/>
                                                  </ListItem>
                                              </List>
                                          </CardContent>
                                      </Card>
